...
public class PageRedirects : IdItem
{
    ...
    /// </returns>
    public static ValueTask<PageRedirects?> GetPageRedirectsAsync(
        IDataStore dataStore,
        string title,
        string wikiNamespace,
        string? domain)
        => dataStore.GetItemAsync<PageRedirects>(GetId(title, wikiNamespace, domain));
    ...
    /// </param>
    public static async Task<PageRedirects> NewAsync(
        IDataStore dataStore,
        string title,
        string wikiNamespace,
        string? domain,
